...
<html lang="en">
 ...
 <?php
  ...
  if (isset($_POST['Simpan'])) 
  {
    ...
    mysqli_query($connection, "insert into kategori value ('$kodekategori','$namakategori','$kategoriket','$kategoriref') ");
  ...
  <div class="jumbotron jumbotron-fluid">
    ...
    <form method="POST" enctype="multipart/form-data">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" id="namakategori" name="inputnama" placeholder="Nama Kategori" required="">
        </div>        
      </div>
      <div class="form-group row">
        <label for="kategoriket" class="col-sm-2 col-form-label">Kategori Keterangan</label>
        <div class="col-sm-10">
          <input type="text" class="form-control" id="kategoriket" name="inputket" placeholder="Kategori Keterangan" required="">
        </div>        
      </div>
       <div class="form-group row">
        <label for="kategoriref" class="col-sm-2 col-form-label">Kategori Referensi</label>
        <div class="col-sm-10">
          <input type="text" class="form-control" id="kategoriref" name="inputref" placeholder="Kategori Referensi" required="">
        </div>        
      </div>
