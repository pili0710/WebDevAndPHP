...
<?php 
    ...
    $editdestinasi = mysqli_query($connection, "SELECT * FROM destinasi, fotodestinasi WHERE fotoID = '$kodefoto' and destinasi.destinasiID = fotodestinasi.destinasiID");
...
<div class="row">
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                     ...
                     <td>
                        <a href="photodestinasihapus.php  ?hapusfoto=<?php echo $row['fotoID']?>" class="btn btn-danger btn-sm" title="EDIT">
