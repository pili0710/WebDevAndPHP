...
<html lang="en">
 ...
 <?php
	...
	if (isset($_POST['Simpan'])) 
	{
		...
		mysqli_query($connection, "insert into beritawisata value ('$kodeberita','$beritajudul','$beritatipe', '$beritaisi' ,'$kodearea') ");
	...
	<div class="jumbotron jumbotron-fluid">
		...
		<form method="POST" enctype="multipart/form-data">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="beritatipe" name="inputtipe" placeholder="Tipe Berita" required="">
				</div>				
			</div>	
			<div class="form-group row">
				<label for="beritaisi" class="col-sm-2 col-form-label">Isi Berita</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" id="beritaisi" name="inputisi" placeholder="Isi Berita" required="">
				</div>				
			</div>	
