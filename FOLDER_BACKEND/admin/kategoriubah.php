...
<?php 
    ...
    $kategoriref = $_POST['inputref'];
      ...
      if(empty($nama))
      {
        mysqli_query($connection, "UPDATE kategori SET kategorinama='$namakategori', kategoriketerangan= '$kategoriket', kategorireferensi= '$kategoriref' WHERE kategoriID = '$kodekategori'");
        header("location:kategori.php");
      } 
  ...
  <div class="col-sm-10">
  	...
  	<form method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group row">
        	...
        	<div class="col-sm-10">
        		<input type="text" class="form-control" id="kategoriket" name="inputket" value="<?php echo $rowedit["kategoriketerangan"]?>">
        	</div>
        </div>

         <div class="form-group row">
          <label for="kategoriref" class="col-sm-2 col-form-label">Kategori Referensi</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" id="kategoriref" name="inputref" value="<?php echo $rowedit["kategorireferensi"]?>">
          </div>
        </div> 
...
<div class="row">
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                     ...
                     <td>
                        <a href="kategorihapus.php  ?hapuskategori=<?php echo $row['kategoriID']?>" class="btn btn-danger btn-sm" title="EDIT">
