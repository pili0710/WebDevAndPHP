...
<?php 
    ...
    if(isset($_POST['ubah']))
    {
      ...
      if(empty($nama))
      {
        mysqli_query($connection, "UPDATE restoran SET fotonama='$namafoto', areaID='$kodearea' WHERE fotoID = '$kodefoto'");
        header("location:photoresto.php");
      } 
      ...
      if(($ekstensifile == "jpg") or ($ekstensifile == "JPG"))
      {
        ...
        mysqli_query ($connection, "UPDATE restoran SET fotonama= '$namafoto', fotoID='$kodearea',fotofile='$nama' WHERE fotoID = '$kodefoto'");
        header("location:photoresto.php");
      }
    }
    $dataarea = mysqli_query($connection, "select * from area");

    $kodefoto = $_GET["ubahresto"];
    $editfoto = mysqli_query($connection, "SELECT * FROM restoran WHERE fotoID = '$kodefoto'");
    $rowedit = mysqli_fetch_array($editfoto);

    $editarea = mysqli_query($connection, "SELECT * FROM area, restoran WHERE fotoID = '$kodefoto' and area.areaID = restoran.areaID");
...
<body>
  ...
  <div class="col-sm-10">
    <div class="jumbotron jumbotron-fluid">
      <div class="container">
        <h1 class="display-4">edit photo resto wisata</h1>
      </div>
    </div>
...
<div class="row">
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                     ...
                     <td>
                        <a href="photorestohapus.php  ?hapusresto=<?php echo $row['fotoID']?>" class="btn btn-danger btn-sm" title="EDIT">
