...
<?php 
	...
	if (isset($_POST['Simpan'])) 
	{
		...
		if (($ekstensifile == "jpg") or ($ekstensifile == "JPG")) 
		{
			...
			mysqli_query($connection, "insert into fotoarea value('$kodefoto','$namafoto',
				'$wilayahfoto', '$kodearea','$nama')");
 ...
 <body>
 	...
 	<div class="col-sm-10">
 		<div class="jumbotron jumbotron-fluid">
 			<div class="container">
 				<h1 class="display-4">Input Foto Area Wisata</h1>
 			</div>
 		</div>
 		...
 		<form method="POST" enctype="multipart/form-data">
 			...
 			<div class="form-group row">
 				<label for="wilayahfoto" class="col-sm-2 col-form-label">Wilayah Photo</label>
 				<div class="col-sm-10">
 					<input type="text" class="form-control" id="namafoto" name="inputwilayah" placeholder="Wilayah Photo" >
 				</div> 				
 			</div>
 ...
 <div class="row">
 	...
 	<div class="col-sm-10">
 		<div class="jumbotron jumbotron-fluid">
 			<div class="container">
 				<h1 class="display-4">Daftar Foto Area Wisata</h1>
 			</div>
 		</div>
 		...
 		<form method="POST">
                        <div class="form-group row mb-2">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="search" class="form-control" id="search" value="<?php if(isset($_POST['search'])) { echo $_POST['search']; }?>" placeholder="Cari Nama Foto Area">
                            </div>
 		...
 		<tbody>
 			...
 			{ ?>
 				<tr>
 					...
 					<td>
 						<a href="photoareahapus.php?hapusfoto=<?php echo $row['fotoID']?>" class="btn btn-danger btn-sm" title="DELETE">
