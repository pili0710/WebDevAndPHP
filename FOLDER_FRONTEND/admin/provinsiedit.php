        ...
        <div class="card shadow mb-4">
            <?php
                ...
                if(isset($_POST['Simpan']))
                {
                    ...
                    mysqli_query($connection, " UPDATE provinsi SET provinsinama='$provinsinama', provinsitglberdiri='$provinsitglberdiri'
                ...
                <div class="col-sm-10">
                    ...
                    <form method="POST">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" name="inputid" id="idprovinsi" value="<?php echo $rowedit["provinsiID"]?>" readonly> 
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="namaprovinsi" class="col-sm-2 col-form-label">Nama</label>
                            <div class="col-sm-10">
                            <input type="text" class="form-control" name="inputnama" id="namaprovinsi" placeholder="Masukan Nama Provinsi" value="<?php echo $rowedit["provinsinama"]?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="tanggal" class="col-sm-2 col-form-label">Tanggal Berdiri</label>
                            <div class="col-sm-10">
                            <input type="date" class="form-control" name="inputtgl" id="tanggal" value="<?php echo $rowedit["provinsitglberdiri"]?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-2"> 
                            ...
                            <div class="col-sm-10">
                                <input type="submit" class="btn btn-success" value="Perbaharui" name="Simpan"> 
